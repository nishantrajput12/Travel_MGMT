				...
				<div class="col-sm-12">
					...
					<div class="search">
    					...
    					<form name="flightSearch" action="returnTripOutboundFlightSearch.php" method="POST">
							...
							<label for="children">Luggage<p> </p></label>
								<div class="form-group">
   									<select id= "children" class="selectpicker form-control" data-size="5" required>
			...
			<!-- FOOTER SECTION STARTS -->
				...
				<div class="footer col-sm-12">
					...
					<div class="col-sm-4">
						...
						Alvas, mijar <br> Karnataka
						</div>
				
						<div class="footerText">
							E-mail: nishant@tourism_management.com
						</div>
